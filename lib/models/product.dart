...
class Product extends ChangeNotifier{
  ...
  Future<void> save() async{
    ...
    //lógica para adicionar ou excluir imagens
    //IMAGES [URL1,URL2,URL3]
    //NEWIMAGES [URL3, FILE1]
    //UPDATE [URL3, FURL1]

    //MANDA FILE 1 PARA STORAGE E ELE RETORNA URL -> FURL1
    //EXCLUI URL1 DO STORAGE
    //EXCLUI URL2 DO STORAGE
    ...
    for(final newImage in newImages){
      if(images.contains(newImage)){
        ...
        //salvar a imagem com um id gerado automaticamente pelo pacote UUID
